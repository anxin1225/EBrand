...
public class GetAgendaTask extends AsyncTask<Void, Void, ParamDown>
{
    private OnResultListener mResultListener;

    public GetAgendaTask(final OnResultListener mResultListener) {
    ...
    protected ParamDown doInBackground(final Void... array) {
        ...
        paramUp.type = "metting_get_arrangement_list";
